...
const routes: Routes = [
	...
	},
	{
		path: 'connect',
		loadChildren: () =>
			import('./strava-connect/strava-connect.module').then(
				(m) => m.StravaConnectPageModule,
			),
	},
	{
		path: 'redirect/exchange_token',
		loadChildren: () =>
			import('./strava-redirect/strava-redirect.module').then(
				(m) => m.StravaRedirectPageModule,
			),
	},
	{
		path: '',
